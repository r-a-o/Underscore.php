...
class UnderscoreArraysTest extends PHPUnit_Framework_TestCase {
  ...
  public function testFlatten() {
    ...
    // from js
    // var_dump(__::flatten(array(array(array(4)))));
    // __::flatten(array(1, array(2), array(3, array(4))));
  ...
  public function testZip() {
    ...
    $this->assertEquals($expected, __::zip($numbers, $letters), 'can perform normal zip()');
    $this->assertEquals($expected, __($numbers)->zip($letters), 'can perform OO-style zip()');
  ...
  public function testObject() {
    ...
    $expected = (object) $stooges;
    $this->assertEquals($expected, __::object($names, $ages));
    $this->assertEquals($expected, __::object($stooges));

    // extra
    $this->assertEquals($expected, __($stooges)->object(), 'can perform OO-style object()');
  ...
  public function testSortedIndex() {
    ...
    $this->assertEquals(3, __::sortedIndex($list, 35));
    // TODO
